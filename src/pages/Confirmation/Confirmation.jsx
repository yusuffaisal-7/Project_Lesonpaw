...
// const SkeletonCard = () => (
//   <div className="bg-white rounded-xl shadow-md p-6 space-y-4 border border-[#70C5D7] border-opacity-10">
//     <div className="flex items-center space-x-4">
...
//         <div className="bg-gradient-to-r from-[#005482] to-[#003654] rounded-2xl overflow-hidden mb-8 shadow-xl">
//           <div className="relative">
...
//                       Confirmations Dashboard
//                     </h1>
//                     <div className="h-1.5 w-24 bg-[#FCBB45] rounded-full"></div>
//                   </div>
//                   <div className="flex items-center gap-4">
//                     <div className="bg-white/10 rounded-xl px-4 py-2.5 backdrop-blur-sm">
//                       <div className="flex items-center gap-2">
//                         <FaUserGraduate className="text-[#FCBB45] text-lg" />
//                         <span className="text-[#70C5D7] font-semibold">
//                           {filteredConfirmations.length}
//                         </span>
...
//                     <span className="text-[#70C5D7] text-sm font-medium">
...
//                       value={searchQuery}
//                       onChange={(e) => setSearchQuery(e.target.value)}
//                       className="w-full md:w-80 pl-12 pr-4 py-3.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-white/60 focus:outline-none focus:border-[#FCBB45] focus:ring-2 focus:ring-[#FCBB45]/30 transition-all text-sm"
//                     />
//                     <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white/60 group-focus-within:text-[#FCBB45] transition-colors">
//                       <FaSearch />
//                     </div>
//                     {searchQuery && (
//                       <button
...
//                   </div>
//                   {searchQuery && (
//                     <div className="mt-2 text-[#70C5D7] text-sm font-medium">
//                       Found {filteredConfirmations.length} matching results
//                     </div>
//                   )}
//                 </div>
...
//           <button
//             onClick={() => console.log('Confirmations:', confirmations, 'User:', user)}
//             className="bg-[#70C5D7]/10 text-[#005482] px-4 py-2 rounded-lg mb-6 text-sm font-medium hover:bg-[#70C5D7]/20 transition-colors"
//           >
//             Log Confirmations
//           </button>
//         )}

//         {/* Enhanced Confirmations Grid */}
//         {isLoading ? (
//           <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
//             {[1, 2, 3].map((index) => (
//               <SkeletonCard key={index} />
...
//           </div>
//         ) : error ? (
//           <div className="bg-[#DA3A60]/10 border border-[#DA3A60] rounded-xl p-6 text-[#DA3A60]">
//             <p className="font-semibold">Error loading confirmations</p>
//             <p className="text-sm mt-1 opacity-80">{error.message}</p>
//           </div>
//         ) : filteredConfirmations.length === 0 ? (
//           <div className="text-center py-16 bg-[#70C5D7]/5 rounded-xl border border-[#70C5D7]/10">
//             <div className="w-16 h-16 mx-auto bg-[#FCBB45]/10 rounded-full flex items-center justify-center mb-4">
//               <FaUserGraduate className="text-[#FCBB45] text-2xl" />
//             </div>
//             <p className="text-[#005482] text-lg font-semibold">No confirmations found</p>
//             {searchQuery && (
//               <button
//                 onClick={() => setSearchQuery('')}
//                 className="mt-4 text-[#DA3A60] hover:underline transition-all font-medium"
//               >
//                 Clear search
//               </button>
//             )}
...
//                 initial={{ opacity: 0, y: 20 }}
//                 animate={{ opacity: 1, y: 0 }}
//                 className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-[#70C5D7]/10 group"
//               >
//                 <div className="p-6 flex flex-col h-full">
//                   <div className="flex items-start gap-4 mb-6">
//                     <div className="w-12 h-12 bg-[#FCBB45] rounded-xl flex items-center justify-center text-white flex-shrink-0 group-hover:scale-105 transition-transform">
//                       <FaUserGraduate className="text-xl" />
//                     </div>
//                     <div className="flex-grow min-w-0">
//                       <h3 className="text-lg font-semibold text-[#005482] mb-1 truncate">
...
//                     </div>
//                   </div>
//                   <div className="mt-6 pt-4 border-t border-[#70C5D7]/10 flex gap-3">
//                     <button
//                       onClick={() => handleViewDetails(confirmation)}
//                       className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-[#70C5D7]/10 text-[#005482] rounded-lg hover:bg-[#70C5D7]/20 transition-all font-medium"
//                     >
//                       <FaEye className="text-[#FCBB45]" /> View Details
//                     </button>
//                     <button
//                       onClick={() => handleDelete(confirmation._id)}
//                       className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-[#DA3A60] text-white rounded-lg hover:bg-[#DA3A60]/90 transition-all font-medium"
//                     >
//                       <FaTrash /> Delete
//                     </button>
//                   </div>
...
//               animate={{ opacity: 1 }}
//               exit={{ opacity: 0 }}
//               className="fixed inset-0 bg-[#005482]/80 flex items-center justify-center p-4 z-50 overflow-y-auto backdrop-blur-sm"
//               onClick={handleCloseDetails}
//             >
//               <motion.div
//                 initial={{ scale: 0.95, y: 20 }}
...
//                 onClick={(e) => e.stopPropagation()}
//               >
//                 <div className="bg-gradient-to-r from-[#005482] to-[#003654] px-6 sm:px-8 py-6">
//                   <div className="flex items-center justify-between">
//                     <div className="flex items-center gap-4">
//                       <div className="w-14 h-14 bg-[#FCBB45] rounded-xl flex items-center justify-center text-white">
//                         <FaUserGraduate className="text-2xl" />
...
//                     <button
//                       onClick={handleCloseDetails}
//                       className="text-white hover:text-[#DA3A60] transition-colors p-2 hover:bg-white/10 rounded-lg"
//                     >
//                       <FaTimes className="text-xl" />
//                     </button>
//                   </div>
//                 </div>
//                 <div className="p-6 sm:p-8 space-y-6">
//                   <div className="bg-[#70C5D7]/5 rounded-xl overflow-hidden">
//                     <div className="px-6 py-4 bg-[#70C5D7]/10">
//                       <h4 className="text-lg font-semibold text-[#005482]">Confirmation Details</h4>
//                     </div>
//                     <div className="p-6 space-y-6">
//                       <div>
//                         <label className="text-sm font-medium text-[#005482]/70 block mb-2">
//                           Tutor Name
//                         </label>
//                         <p className="text-[#005482] font-medium bg-white p-3.5 rounded-lg border border-[#70C5D7]/20">
//                           {selectedConfirmation.tutorName}
//                         </p>
//                       </div>
//                       <div>
...
//                           Email Address
//                         </label>
//                         <p className="text-[#005482] font-medium flex items-center gap-2 bg-white p-3.5 rounded-lg border border-[#70C5D7]/20 break-all">
//                           <FaEnvelope className="text-[#FCBB45] flex-shrink-0" />
//                           {selectedConfirmation.email}
//                         </p>
//                       </div>
//                       <div>
...
//                   </div>
//                 </div>
//                 <div className="bg-[#70C5D7]/5 px-6 sm:px-8 py-4 border-t border-[#70C5D7]/10">
//                   <div className="flex justify-end">
//                     <button
//                       onClick={handleCloseDetails}
//                       className="px-6 py-2.5 text-white bg-[#DA3A60] rounded-lg hover:bg-[#DA3A60]/90 transition-all font-medium"
//                     >
//                       Close
//                     </button>
//                   </div>
...
const Confirmation = () => {
  ...
  const { data: userRole, isLoading: roleLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.data.admin ? 'admin' : 'user';
    },
  });

  // Fetch confirmations based on role
  const { data: confirmations = [], isLoading, error, refetch } = useQuery({
    queryKey: ['confirmations', user?.email, userRole],
    enabled: !!user?.email && !!userRole,
    queryFn: async () => {
      console.log('Fetching confirmations for:', { email: user.email, role: userRole });
      try {
        let url = '/confirmations';
        if (userRole !== 'admin') {
          // Non-admins fetch confirmations for their email
          url = `/confirmations?email=${encodeURIComponent(user.email)}`;
        }
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      Swal.fire({
        ...
        text: 'The confirmation has been deleted successfully.',
        timer: 1500,
    ...
    onError: (error) => {
      console.error('Error deleting confirmation:', error.response?.data || error.message);
      let errorMessage = 'Failed to delete confirmation. Please try again.';
      if (error.response?.status === 401) {
        errorMessage = 'Authentication error. Please log in again.';
      } else if (error.response?.status === 404) {
        errorMessage = 'Confirmation not found. It may have been already deleted.';
      } else if (error.response?.status === 403) {
        errorMessage = 'Forbidden: You are not authorized to delete this confirmation.';
      }
      Swal.fire({
        icon: 'error',
        title: 'Error',
  ...
  const handleDelete = (confirmationId) => {
    if (!user?.email) {
      Swal.fire({
        ...
        text: 'Please log in to delete confirmations.',
        confirmButtonColor: '#DA3A60',
        background: '#FFFFFF',
        iconColor: '#FCBB45',
      });
    ...
    Swal.fire({
      ...
      text: 'Are you sure you want to delete this confirmation?',
      icon: 'warning',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {process.env.NODE_ENV === 'development' && (
          <button
            onClick={() => console.log('Confirmations:', confirmations, 'User:', user, 'Role:', userRole)}
            className="bg-[#70C5D7]/10 text-[#005482] px-4 py-2 rounded-lg mb-6 text-sm font-medium hover:bg-[#70C5D7]/20 transition-colors"
          >
            Log Confirmations
          </button>
