        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-[#005482]">{translate('personalInformation')}</h2>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-[#005482]">{translate('academicInformation')}</h2>
            </div>
            <div className="space-y-4">
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-[#005482]">{translate('guardianInformation')}</h2>
            </div>
            <div className="space-y-4">
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 md:col-span-2 lg:col-span-3">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-[#005482]">{translate('addressInformation')}</h2>
            </div>
        ...
        <div id="profile-form" className="mt-12">
          <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 border border-gray-100">
            <h3 className="text-xl sm:text-2xl font-bold text-[#005482] mb-8">
              {student ? translate('updateProfile') : translate('editProfile')}
            </h3>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              {/* Profile Photo Section */}
              <div className="mb-8">
                <label className="block text-lg font-semibold text-[#005482] mb-4">{translate('profilePhoto')}</label>
